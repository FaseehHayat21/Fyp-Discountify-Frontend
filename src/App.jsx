...
import Vendors from './Component/Student/DealsAndDiscount/Vendors';
...
import ForgotPassword from './Component/LoginSample/ForgetPassword/ForgotPassword';
import VerifyOTP from './Component/LoginSample/ForgetPassword/VerifyOTP';
import ResetPassword from './Component/LoginSample/ForgetPassword/ResetPassword';
      ...
      <RegisterState>
        <Routes>
          ...
          <Route path='/s/*' element={!userType === 'Student' ? <Navigate to="/login" /> : <StudentPage />} >
            ...
            <Route path="dealsAndDiscount" element={<Vendors />} />
          ...
          <Route path='/v/*' element={!userType === 'Vendor' ? <Navigate to="/login" /> : <VendorPage />} >
            ...
            <Route path="vendorProfile" element={<Notification />} />
